This folder is the blocked list — everything that cannot move until Eli or Jonathon answers.

If you are picking this engagement up cold, read this folder before anything else. It is
the difference between "not built yet" and "built, waiting on someone".
...
that someone still owes something. Leaving an answered file here is worse than not having
the folder.
